#!/usr/bin/env python3
# Auto-generated: exact rebuild helper for "best"
# Usage:
#   python rebuild_best.py --weights /path/to/best.keras  (opcional, para carregar pesos)
#   python rebuild_best.py --print-summary
...
def build_model_from_config():
    cfg = load_json("best_architecture.json")
...
def maybe_compile(model):
    try:
        comp = load_json("best_compile.json")
...
def main():
    ...
    ap.add_argument("--weights", type=str, default=None, help="Path to best.keras (optional)")
