...
def parse_args():
    ...
    # ajustes finos do modo compare (opcionais)
...
def _apply_compare_overrides(args, *, epochs=None, extra_fraction=None, max_per_class=None, batch_size=None, img_size=None):
    a = _clone_args(args)
...
def main():
    ...
    out_dir = make_outdir(prefix="run", root=args.out_root)
    print(f"[INFO] Salvando saídas em: {out_dir}")
