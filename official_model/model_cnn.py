...
# =========================
# Keras Applications (modelo pronto) mantendo seu pipeline [0,1] e grayscale
# =========================
...
def build_keras_app_model(
    ...
    if channels == 1:
        ...
        # fallback: projeta para 3 canais sem alterar seu pipeline
        x = L.Conv2D(3, kernel_size=1, padding="same", name="to_rgb_conv")(x)

    # 2) manter seu pipeline [0,1], mas adaptar para o preprocess do ImageNet
    #    A maioria dos preprocess_input assume [0,255], então escalamos aqui.
    ...
    # 4) cabeça de classificação (mantém softmax float32 como seu modelo)
